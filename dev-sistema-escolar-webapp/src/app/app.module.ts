...
import { ConfirmacionEventoModalComponent } from './modals/confirmacion-evento-modal/confirmacion-evento-modal.component';
import { AsistentesEventoModalComponent } from './modals/asistentes-evento-modal/asistentes-evento-modal.component';
...
@NgModule({
  declarations: [
    ...
    ConfirmacionEventoModalComponent,
    AsistentesEventoModalComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
